...
| 순위 | 소스 | 내용 |
|------|------|------|
| 1 | [legalize-kr](https://github.com/legalize-kr/legalize-kr) + [precedent-kr](https://github.com/legalize-kr/precedent-kr) | 공식 원문 기반 로컬 미러 Markdown (직접 공식 사이트 확인과 provenance 분리; 최신 개수는 upstream repo 확인) |
