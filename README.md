...
| Source Grade / VERIFIED 계약 | `skills/beopsuny/references/citation-verification-contract.md`, `skills/beopsuny/references/source-grading.md`, `skills/beopsuny/assets/policies/source_grades.yaml` | `check_citation_verification_contract_single_source`, `check_source_grading_verified_contract`, `legal_status_tag`, `no_verified_uncertainty` |
