...
8. `python3 tests/validate_skill_contracts.py`, `python3 tests/evaluate_scenario_outputs.py`, `python3 -m py_compile tests/validate_skill_contracts.py tests/evaluate_scenario_outputs.py`, `git diff --check`를 실행한다.
