...
| Company context trust | `skills/beopsuny/SKILL.md` (`## 회사 맥락` — 읽기 전용·트러스트 경계·matter 범위 제약 소유), `skills/beopsuny/references/self-verification.md#retrieved-content-trust` | `check_skill_company_context_read_only_and_trust_boundary`, `check_cross_matter_scope_boundary_has_a_home`, `tests/test_cross_matter_scope_rule.py`, `router-10`, `router-13`, `router-18` |
