...
| 품질 계약 | 기준 문서 | 회귀 검증 |
| --- | --- | --- |
| Always-on legal conclusion gates | `skills/beopsuny/references/citation-verification-contract.md`, `skills/beopsuny/references/self-verification.md`, `skills/beopsuny/references/output-formats.md` | `check_skill_quality_contract_router_map`, `check_skill_gate_attachment_and_draft_first`, `check_router_always_on_legal_gates`, `router-01`, `router-05` |
