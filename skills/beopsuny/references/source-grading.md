...
| 라벨 | 결론 근거 | 대표 예시 |
| --- | --- | --- |
| **공식 원문** | 가능 | 법령 원문, 시행령·시행규칙, 행정규칙 원문, 대법원·헌재·하급심 판례 원문, 법제처 해석례, 처분·의결서 원문 |
| **공식 실무자료** | 보조 또는 조건부 가능 | 규제기관 가이드라인·해설서·FAQ·보도자료, 정부 공식 안내, 계류 의안 |
...
**보조 또는 조건부 가능**: 실무 적용, 기관 입장, 정책 동향을 설명하는 데 유용하지만, 법률 결론은 가능한 한 공식 원문과 분리해 표시한다.

**단독 결론 근거 불가**: 쟁점 발견과 해석 후보로만 사용한다. 결론에는 공식 원문 또는 공식 실무자료 확인이 필요하다.
...
※ 위 내용은 단일 2차 소스의 의견이며, 결론은 공식 원문 또는 공식 실무자료를 우선 확인하세요.
```
...
> **모든 핵심 결론은 공식 원문 또는 공식 실무자료로 뒷받침되어야 한다.**
...
| 소스 | 기본 라벨 |
| --- | --- |
| legalize-kr (로컬 법령) | **공식 원문** |
| precedent-kr 대법원 | **공식 원문** |
| precedent-kr 하급심 | **공식 원문: 하급심** |
...
A. 둘 다 원문이면 공식 원문이다. 다만 하급심은 상급심에 의해 변경될 수 있으므로 `공식 원문: 하급심`처럼 caveat를 붙인다.
