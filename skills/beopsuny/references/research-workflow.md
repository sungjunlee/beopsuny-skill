...
| `source_authority` | 공식 원문 / 공식 실무자료 / 해설·의견 / 참고 제외 |
...
| 상태 | 결론 표현 |
| --- | --- |
| 모든 필수 authority가 공식 원문/공식 실무자료 + `[VERIFIED]` | “확인한 범위에서는 …” |
...
대법원 판례는 `공식 원문`, 하급심은 `공식 원문: 하급심`으로 표시한다. 하급심만 있으면 상급심 변경 가능성을 caveat로 붙인다.
