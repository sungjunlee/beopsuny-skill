...
value: ""
state: "answered"
source_grade: "[Grade A] [VERIFIED]"
quote: ""
location: ""
notes: ""
```

계약 문서에서 온 값은 quote와 location을 붙인다. 법령/행정규칙/판례에서 온 값은 Source Grade와 verification status를 붙인다. 후보 체크리스트나 clause mapping만으로는 `answered`가 될 수 없다.
