...
| `references/` | 작업 흐름과 실행 환경 설명 | source access, contract guide, memory, output formats |
...
- 먼저 검색어 힌트 없이 실시간 법률 조사를 한 뒤 recall/audit 보강이 필요한 경우

금지:

- 지식 자산을 최초 경로, 결론 근거, 포괄 체크리스트처럼 사용
- 개인정보 외 영역 메모를 taxonomy/retrieval hints/authority map처럼 주입
