...
- [ ] #109 (Batch 1, ~1 session) virtual workflow map — 7개 workflow(commercial/privacy/labor/regulatory/litigation/startup/cross-border)의 trigger·required references·output mode·verification 표, plugin split 전/후 경계를 DESIGN.md와 정렬, 정적 구조 검증 추가
