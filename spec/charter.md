...
- O4 [validated] A user in Claude Code, Codex, or Claude Desktop can identify whether Beopsuny is in Full or Lite mode and see provenance that distinguishes local official-source mirrors, direct official-source checks, API fallback, and insufficient-source states. · src: execution — live forward-eval smoke 2026-07-09 (claude-sonnet-5, 8/8 PASS): `tests/forward_evals/evidence/o4-live-sonnet5-20260709.yaml`. Family-wise Full/Lite identification (o4-01), local-mirror provenance with commit/frontmatter trail (o4-02, o4-03), direct-official + API-fallback with honest 503 degrade (o4-04), non-existent statute/case traps ending in verified-absence or `[INSUFFICIENT]` (o4-06, o4-07), promulgated-vs-effective distinction (o4-08). Former known limit resolved: the 2026-07-09 pure-Lite simulation leak (o4-05, model detected the real `~/.beopsuny` behind the empty `BEOPSUNY_DATA_ROOT`) was fixed in #222 by stating the simulation premise in the runner; live recheck 2026-07-10 shows clean Lite behavior: `tests/forward_evals/evidence/o4-05-recheck-live-sonnet5-20260710.yaml` (tradeoff: o4-05 now exercises Lite behavior, not mode detection — detection stays covered by o4-01).
